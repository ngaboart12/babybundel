...
if(!Fontsloaded){
  ...
  return (
    <TouchableOpacity onPress={()=> navigation.navigate('single',{id:_id})}  style={{width:150,minHeight:200,marginTop:10,backgroundColor:'#f4f4f4',marginLeft:5,marginRight:5,gap:10}}>
