      ...
      name='home'
        options={{
          ...
          tabBarIcon: ({ color }) => (
            ...
            <Path d="M9.13478 20.7733V17.7156C9.13478 16.9351 9.77217 16.3023 10.5584 16.3023H13.4326C13.8102 16.3023 14.1723 16.4512 14.4393 16.7163C14.7063 16.9813 14.8563 17.3408 14.8563 17.7156V20.7733C14.8539 21.0978 14.9821 21.4099 15.2124 21.6402C15.4427 21.8705 15.7561 22 16.0829 22H18.0438C18.9596 22.0023 19.8388 21.6428 20.4872 21.0008C21.1356 20.3588 21.5 19.487 21.5 18.5778V9.86686C21.5 9.13246 21.1721 8.43584 20.6046 7.96467L13.934 2.67587C12.7737 1.74856 11.1111 1.7785 9.98539 2.74698L3.46701 7.96467C2.87274 8.42195 2.51755 9.12064 2.5 9.86686V18.5689C2.5 20.4639 4.04738 22 5.95617 22H7.87229C8.55123 22 9.103 21.4562 9.10792 20.7822L9.13478 20.7733Z" fill="#FFB648"/>
            </Svg>
          ),
        }}
       component={DrawerTab}/>
      ...
      options={{
        ...
        tabBarIcon: ({ color }) => {
          if(falsevalue.length>0){
           ...
           <Svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <Path fill-rule="evenodd" clip-rule="evenodd" d="M12 17.8476C17.6392 17.8476 20.2481 17.1242 20.5 14.2205C20.5 11.3188 18.6812 11.5054 18.6812 7.94511C18.6812 5.16414 16.0452 2 12 2C7.95477 2 5.31885 5.16414 5.31885 7.94511C5.31885 11.5054 3.5 11.3188 3.5 14.2205C3.75295 17.1352 6.36177 17.8476 12 17.8476Z" stroke="#8E8D8D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <Path d="M14.3888 20.8572C13.0247 22.3719 10.8967 22.3899 9.51947 20.8572" stroke="#8E8D8D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </Svg>
        <View style={{left:12,top:0,position:'absolute',backgroundColor:'darkred',width:15,height:15,borderRadius:10,alignItems:'center'}}>
              <Text style={{textAlign:'center',color:'white'}}>{falsevalue.length}</Text>
            </View>
        </View>   
              )
          }else{
