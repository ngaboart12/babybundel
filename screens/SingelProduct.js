...
const SingelProduct = ({ route }) => {
  ...
  const selectProduct = async (req, res) => {
    ...
    const response = await axios
      .get(`http://192.168.1.67:6000/api/user/product/${id}`)
      .then((response) => {
    ...
    <View style={{ paddingTop: 40, height: "100%" }}>
      ...
      {isLoading ? (
        ...
        <View style={{ height: "100%" }}>
          <Image
            source={{ uri: `${singelProduct.image}` }}
            style={{ width: "100%", height: "60%" }}
          />
          <View style={{ padding: 20 }}>
            <Text
              style={{ fontSize: 30, fontWeight: 600, fontFamily: "Red-Hat" }}
            >
              {singelProduct.name}
            </Text>
          </View>
          <View style={{ position: "absolute", right: 10, top: 50 }}>
            <TouchableOpacity
              onPress={() => dispatch(addToWish(singelProduct))}
            >
              <Svg
          ...
          <View style={{ paddingHorizontal: 20, gap: 5 }}>
            ...
            <Text
              style={{ color: "#656565", fontFamily: "Red-Hat", fontSize: 16 }}
            >
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa
              provident doloribus minima, ullam soluta assumenda quis
              exercitationem omnis doloremque libero inventore amet fuga magnam
            </Text>
          ...
          >
            <TouchableOpacity
              onPress={() => dispatch(addToCart(singelProduct))}
              style={{
                width: "50%",
            ...
            >
              <Text style={{ color: "#FFB648", fontSize: 18 }}>
                Add to cart
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text
                style={{ color: "white", fontSize: 20, fontFamily: "Red-Hat" }}
              >
                check it out
              </Text>
            </TouchableOpacity>
